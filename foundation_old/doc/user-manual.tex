...
\title{Layered Architecture: domain-driven approach}
\author{Diana Bondar}
\date{\today}
\usepackage{hyperxmp}
\hypersetup{
    pdftitle={Layered Architecture: domain-driven approach},
    pdfauthor={Diana Bondar},
    pdfsubject={},
    pdfcopyright={Copyright (C) 2019 by Diana.  All rights reserved.}
}
